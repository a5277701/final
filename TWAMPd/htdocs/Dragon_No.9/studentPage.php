  ...
  <div class="container">
    <div class="content">
      ...
      <div style="margin:0 auto; width:250px; height:80px">
        ...
        <hr>
        <input type="button" value="預借頁面" onclick="document.location.href='reservation.php'">
        <input type="button" value="管理頁面" onclick="document.location.href='management.php'">
        <input type="button" value="查詢頁面" onclick="document.location.href='searchDesk.php'">
        <br><br>
