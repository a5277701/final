...
CREATE TABLE `order` (
  ...
  `quantity` int(2) unsigned zerofill NOT NULL COMMENT '數量',
  ...
  PRIMARY KEY (`member_no`,`product_no`,`store_no`,`order_no`),
  KEY `product_no` (`product_no`),
  KEY `store_no` (`store_no`),
  KEY `order_no` (`order_no`),
  CONSTRAINT `order_ibfk_3` FOREIGN KEY (`store_no`) REFERENCES `store` (`store_no`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `order_ibfk_1` FOREIGN KEY (`member_no`) REFERENCES `member` (`member_no`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `order_ibfk_2` FOREIGN KEY (`product_no`) REFERENCES `product` (`product_no`) ON DELETE NO ACTION ON UPDATE CASCADE
...
CREATE TABLE `product_price` (
  ...
  CONSTRAINT `product_price_ibfk_5` FOREIGN KEY (`product_no`) REFERENCES `product` (`product_no`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='產品價格';

INSERT INTO `product_price` (`product_no`, `size_no`, `price`) VALUES
(0001,	0001,	200),
(0001,	0002,	150),
(0001,	0003,	100),
(0002,	0001,	200),
