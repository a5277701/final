...
(0019,	'吳美男',	'1986-12-22',	'女',	'0905555557',	'123ss@gmail.com',	'a0018',	'123456');
...
CREATE TABLE `order` (
  ...
  `total` int(6) unsigned NOT NULL COMMENT '總額',
...
INSERT INTO `order` (`order_no`, `id`, `store_name`, `total`, `pickup_date`, `check`) VALUES
(0001,	'mk816017',	'台南分店',	2760,	'2014-06-12',	'no'),
(0002,	'mk816017',	'澎湖分店',	1950,	'2014-06-12',	'no'),
(0003,	'mk816017',	'雲林分店',	2360,	'2014-06-12',	'no'),
(0004,	'a0001',	'新竹分店',	6150,	'2014-06-12',	'no');

DROP TABLE IF EXISTS `order_content`;
CREATE TABLE `order_content` (
  `order_no` int(4) unsigned zerofill NOT NULL COMMENT '訂單編號',
  `pp_no` int(4) unsigned zerofill NOT NULL COMMENT '產品價錢流水號',
  `quantity` int(4) unsigned NOT NULL COMMENT '數量',
  PRIMARY KEY (`order_no`,`pp_no`),
  KEY `product_name` (`pp_no`),
...
INSERT INTO `order_content` (`order_no`, `pp_no`, `quantity`) VALUES
(0001,	0001,	2),
(0001,	0002,	3),
(0001,	0003,	1),
(0001,	0039,	5),
...
CREATE TABLE `product_price` (
  `pp_no` int(4) unsigned zerofill NOT NULL AUTO_INCREMENT COMMENT '流水號',
  `product_name` varchar(12) NOT NULL COMMENT '產品名稱',
...
INSERT INTO `product_price` (`pp_no`, `product_name`, `size_name`, `price`) VALUES
(0001,	'原味蛋捲',	'禮盒',	220),
(0002,	'原味蛋捲',	'罐裝',	170),
(0003,	'原味蛋捲',	'袋子',	120),
(0004,	'咖啡捲心酥',	'禮盒',	190),
