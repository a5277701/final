...
INSERT INTO `order` (`order_no`, `id`, `store_name`, `pickup_date`) VALUES
(0001,	'mk816017',	'高雄總店',	'2014-06-09');
...
(0015,	'原味煎餅',	'煎餅',	'麵粉、砂糖、植物油、奶粉、蛋、奶油、乳化劑、膨脹劑'),
...
(0020,	'牛奶棒',	'棒狀餅乾',	'小麥粉、砂糖、全脂奶粉、塊、棕櫚油、、酥油(棕櫚油)、食鹽、奶油、酵母、香料、大豆卵磷脂、膨脹劑(碳酸氫鈉)、甜味劑(蔗糖素)'),
